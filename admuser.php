           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">           
                <ul class="nav" id="main-menu">	
                  ...
                  <li  >
                        <a class="active-menu"  href="admuser.php"><i class="fa fa-users fa-3x" aria-hidden="true"></i>Manage Users&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;</a>
                    </li>	
                    <li  >
            ...
            <tbody>
             ...
             ?>
              <tr>
                ...
                <td><?php echo $rows['User_Name']; ?></td><?php $ans = "user"; ?></td>
                <td><?php echo $rows['User_Email']; ?></td>
                <td><?php echo $rows['U_Created']; ?></td>
                <td><?php echo'<a href="deleteans.php?id='.$rows['User_ID'].'&stat='.$ans.'" class=" btscol bts ">'?>
