    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">           
                <ul class="nav" id="main-menu">	
                      ...
                      <li style="background-color:white">
                        <a  href="Adminpanel.php"><i class="fa fa-3x fa-question-circle" aria-hidden="true"></i>Manage Question&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;</a>
                    </li>
                    <li>
                        <a class="active-menu" href="admpost.php"><i class="fa fa-3x fa-pencil-square-o" aria-hidden="true"></i>View Posts&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</a>
                    </li>
                  <li  >
                        <a  href="admuser.php"><i class="fa fa-users fa-3x" aria-hidden="true"></i>Manage Users&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;</a>
                    </li>	
                    <li  >
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Manage the Doctors</h2>   
                        <h5>Welcome  , Love to see you back. </h5>

      <div class="col-md-9 col-lg-10 main"><br>
        <h1 class="lead hidden-xs-down">Signed Accounts:</h1>
        <table style="table-layout: fixed; width: 100%" class="table table-hover">
            <thead>
              <tr>
                <th  style=" width: 15%"scope="col">ID</th>
                <th style=" width: 15%"scope="col">Doctor ID</th>
                <th style=" width: 50%"scope="col">Heading</th>
            ...
            <tbody>
             ...
             ?>
              <tr>
                ...
                <td><?php echo $rows['Doc_ID']; ?></td><?php $ans = "post"; ?></td>
                <td style="word-wrap: break-word" ><?php echo $rows['Post_Head']; ?></td>
                <td><?php echo $rows['P_Created']; ?></td>
                <td><?php echo'<a href="deleteans.php?id='.$rows['Post_ID'].'&stat='.$ans.'" class=" btscol bts ">'?>
